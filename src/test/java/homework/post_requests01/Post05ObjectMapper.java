...
public class Post05ObjectMapper extends DummyApiBaseUrl {
    ...
    public void post05() throws IOException {
        ...
        //Set the expected data   //for post requence I need DummyApiDataPojo
        ...
        //Do Assertion   //for request we created DummyApiResponsePojo
        DummyApiResponsePojo actualData = new ObjectMapper().readValue(response.asString(), DummyApiResponsePojo.class);
        //I taken response as string and convert it to 2. parameter (DummyApiResponsePojo.class)
