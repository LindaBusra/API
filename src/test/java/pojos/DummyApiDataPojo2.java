...
public class DummyApiDataPojo2 {
    private int id;
    ...
    public DummyApiDataPojo2() {
    }

    public DummyApiDataPojo2(int id, String employee_name, int employee_salary, int employee_age, String profile_image) {
        this.id = id;
