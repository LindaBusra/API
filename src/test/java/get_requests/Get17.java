...
//    //  other way:
//    String nameOfLowestAge = json.getString("data.findAll{it.employee_age==19}.employee_name");
//    //or
//    List<String> nameOfLowestAge1 = json.getList("data.findAll{it.employee_age==19}.employee_name");
